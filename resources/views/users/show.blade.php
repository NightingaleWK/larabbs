            ...
            <div class="card ">
                <div class="card-body">
                    <ul class="nav nav-tabs">
                        <li class="nav-item">
                            <a class="nav-link bg-transparent @if (env('APP_URL') . request()->getRequestUri() !== request()->url() . '?tab=replies') active @endif"
                    ...
                    @if (env('APP_URL') . request()->getRequestUri() == request()->url() . '?tab=replies')
